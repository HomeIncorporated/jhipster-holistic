...
import com.enterpriseapp.main.EnterpriseappApp;
import com.enterpriseapp.main.config.SecurityBeanOverrideConfiguration;
import com.enterpriseapp.main.domain.JobHistory;
import com.enterpriseapp.main.repository.JobHistoryRepository;
import com.enterpriseapp.main.repository.search.JobHistorySearchRepository;
import com.enterpriseapp.main.service.JobHistoryService;
import com.enterpriseapp.main.web.rest.errors.ExceptionTranslator;
...
import static com.enterpriseapp.main.web.rest.TestUtil.createFormattingConversionService;
...
import com.enterpriseapp.main.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, EnterpriseappApp.class})
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the com.enterpriseapp.main.repository.search test package.
     *
     * @see com.enterpriseapp.main.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
