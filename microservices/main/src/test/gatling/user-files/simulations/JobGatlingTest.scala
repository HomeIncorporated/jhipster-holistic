...
class JobGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Job entity")
        ...
        .repeat(2) {
            ...
            .get("/services/enterpriseapp/api/jobs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new job")
            .post("/services/enterpriseapp/api/jobs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/enterpriseapp${new_job_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created job")
            .delete("/services/enterpriseapp${new_job_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
