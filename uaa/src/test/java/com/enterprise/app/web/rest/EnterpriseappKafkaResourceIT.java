...
import com.enterprise.app.config.SecurityBeanOverrideConfiguration;
...
public class EnterpriseappKafkaResourceIT {
    ...
    @Autowired
    private EnterpriseappKafkaProducer producer;

    @Autowired
    private EnterpriseappKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        EnterpriseappKafkaResource kafkaResource = new EnterpriseappKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/enterpriseapp-kafka/publish?message=test"))
